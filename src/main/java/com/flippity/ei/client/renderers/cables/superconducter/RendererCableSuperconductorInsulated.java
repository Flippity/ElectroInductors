...
public class RendererCableSuperconductorInsulated extends TileEntitySpecialRenderer {
    private static final ResourceLocation resourceloc = new ResourceLocation(com.flippity.ei.reference.Reference.MOD_ID + ":" + "textures/blocks/BlockCableSuperconductorInsulated.png");
    float pixel = 1F/16F;
    ...
    public void renderTileEntityAt(TileEntity te, double x, double y, double z, float scale) {    	
        ...
        {
        drawCore(te);
        TECableSuperconductorInsulated cable = (TECableSuperconductorInsulated) te;
