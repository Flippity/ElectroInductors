...
public class ArmorHazmat extends ItemArmor {
	...
	public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean par3) {
	    ...
	    if(GuiScreen.isShiftKeyDown()){	    	
	        list.add(EnumChatFormatting.RED + "Heavy lead concealed by rubber,");
	        list.add(EnumChatFormatting.RED + "this protects the player from radiation.");
	        ...
	        if(GuiScreen.isCtrlKeyDown()) {
	        	if(itemStack.getItem() == ArmorRegistry.hazmatHelmet) {
	            	...
	            	list.add(EnumChatFormatting.LIGHT_PURPLE + "4" + EnumChatFormatting.RESET + "x" + EnumChatFormatting.YELLOW + "Rubber");
	            	list.add(EnumChatFormatting.LIGHT_PURPLE + "1" + EnumChatFormatting.RESET + "x" + EnumChatFormatting.YELLOW + "Lead Ingot");
	        	}
	        	
	        	if(itemStack.getItem() == ArmorRegistry.hazmatChest) {
	        		list.add(EnumChatFormatting.AQUA + "CRAFTING ");
	            	list.add(EnumChatFormatting.LIGHT_PURPLE + "7" + EnumChatFormatting.RESET + "x" + EnumChatFormatting.YELLOW + "Rubber");
	            	list.add(EnumChatFormatting.LIGHT_PURPLE + "1" + EnumChatFormatting.RESET + "x" + EnumChatFormatting.YELLOW + "Lead Ingot");
	        	}
	        	
	        	if(itemStack.getItem() == ArmorRegistry.hazmatPants) {
	        		list.add(EnumChatFormatting.AQUA + "CRAFTING ");
	            	list.add(EnumChatFormatting.LIGHT_PURPLE + "6" + EnumChatFormatting.RESET + "x" + EnumChatFormatting.YELLOW + "Rubber");
	            	list.add(EnumChatFormatting.LIGHT_PURPLE + "1" + EnumChatFormatting.RESET + "x" + EnumChatFormatting.YELLOW + "Lead Ingot");
	        	}
	        	
	        	if(itemStack.getItem() == ArmorRegistry.hazmatBoots) {
	        		list.add(EnumChatFormatting.AQUA + "CRAFTING ");
	            	list.add(EnumChatFormatting.LIGHT_PURPLE + "4" + EnumChatFormatting.RESET + "x" + EnumChatFormatting.YELLOW + "Rubber");
	        	}
	        }
