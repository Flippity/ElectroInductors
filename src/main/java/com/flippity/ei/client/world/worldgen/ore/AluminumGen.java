package com.flippity.ei.client.world.worldgen.ore;
...
public class AluminumGen implements IWorldGenerator {
	...
	public void generateOverworld(World world, Random rand, int x, int z) {
		generateOre(BlockRegistry.oreAluminum, world, rand, x, z, 2, 16, 58, 0, 512, Blocks.stone);
