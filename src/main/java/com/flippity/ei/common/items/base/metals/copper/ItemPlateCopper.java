...
public class ItemPlateCopper extends Item{
	public ItemPlateCopper() {
		super();
		this.setCreativeTab(Tabs.tabBase);
		this.setTextureName(Reference.MOD_ID + ":plate");
		this.setUnlocalizedName("plateCopper");
	}
	...
	public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean par3) {
	    ...
	    if(GuiScreen.isShiftKeyDown()){
	        list.add(EnumChatFormatting.RED + "A filthy, orange, and flexible plate of copper." + EnumChatFormatting.RESET);
