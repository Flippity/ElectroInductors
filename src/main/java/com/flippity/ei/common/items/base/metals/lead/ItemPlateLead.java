...
public class ItemPlateLead extends Item{
	public ItemPlateLead() {
		super();
		this.setCreativeTab(Tabs.tabBase);
		this.setTextureName(Reference.MOD_ID + ":plate");
		this.setUnlocalizedName("plateLead");
	}
	...
	public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean par3) {
	    ...
	    if(GuiScreen.isShiftKeyDown()){
	        list.add(EnumChatFormatting.RED + "A filthy, heavy, dark-gray, and malleable plate of lead." + EnumChatFormatting.RESET);
