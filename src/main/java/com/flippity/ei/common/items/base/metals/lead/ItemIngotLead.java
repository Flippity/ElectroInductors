...
public class ItemIngotLead extends Item{
	...
	public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean par3) {
	    ...
	    if(GuiScreen.isShiftKeyDown()){
	        list.add(EnumChatFormatting.RED + "A filthy, heavy, dark-gray, and malleable bar of lead." + EnumChatFormatting.RESET);
	        ...
	        if(GuiScreen.isCtrlKeyDown()) {
	            ...
	            list.add(EnumChatFormatting.LIGHT_PURPLE + "1" + EnumChatFormatting.RESET + "x" + EnumChatFormatting.YELLOW + "Lead Dust");
	            list.add(EnumChatFormatting.RED + "OR");
	            list.add(EnumChatFormatting.LIGHT_PURPLE + "1" + EnumChatFormatting.RESET + "x" + EnumChatFormatting.YELLOW + "Lead Ore");
	        }
	    }
	}
