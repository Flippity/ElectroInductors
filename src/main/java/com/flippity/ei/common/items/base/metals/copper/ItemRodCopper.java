...
public class ItemRodCopper extends Item{
	public ItemRodCopper() {
		super();
		this.setCreativeTab(Tabs.tabBase);
		this.setTextureName(Reference.MOD_ID + ":rod");
		this.setUnlocalizedName("rodCopper");
	}
	...
	public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean par3) {
	    ...
	    if(GuiScreen.isShiftKeyDown()){
	        list.add(EnumChatFormatting.RED + "A filthy, and orange rod of copper." + EnumChatFormatting.RESET);
