...
public class ItemOreAluminum extends ItemBlock{

	public ItemOreAluminum(Block block) {
		super(block);
	}
	...
	public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean par3) {
	    ...
	    if(GuiScreen.isShiftKeyDown()){
	        list.add(EnumChatFormatting.RED + "Silvery-white and soft metal," + EnumChatFormatting.RESET);
	        list.add(EnumChatFormatting.RED + "can be crafted into lots of things." + EnumChatFormatting.RESET);
