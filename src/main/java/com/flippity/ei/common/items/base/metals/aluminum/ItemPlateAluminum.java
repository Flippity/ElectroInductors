...
public class ItemPlateAluminum extends Item{
	public ItemPlateAluminum() {
		super();
		this.setCreativeTab(Tabs.tabBase);
		this.setTextureName(Reference.MOD_ID + ":plate");
		this.setUnlocalizedName("plateAluminum");
	}
	...
	public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean par3) {
	    ...
	    if(GuiScreen.isShiftKeyDown()){
	        list.add(EnumChatFormatting.RED + "A shiny, silverish, and flexible plate of aluminum." + EnumChatFormatting.RESET);
