...
public class ItemBlockCopper extends ItemBlock{
	...
	public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean par3) {
	    ...
	    if(GuiScreen.isShiftKeyDown()){
	        list.add(EnumChatFormatting.RED + "A chunk of some reddish-orange, soft," + EnumChatFormatting.RESET);
	        list.add(EnumChatFormatting.RED + "and malleable metal." + EnumChatFormatting.RESET);
	        ...
	        if(GuiScreen.isCtrlKeyDown()) {
	            ...
	            list.add(EnumChatFormatting.LIGHT_PURPLE + "9" + EnumChatFormatting.RESET + "x" + EnumChatFormatting.YELLOW + "Copper Ingot");
	        }
	    }
	}
}