...
public class ItemPipeAluminum extends Item{
	public ItemPipeAluminum() {
		super();
		this.setCreativeTab(Tabs.tabBase);
		this.setTextureName(Reference.MOD_ID + ":pipe");
		this.setUnlocalizedName("pipeAluminum");
	}
	...
	public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean par3) {
	    ...
	    if(GuiScreen.isShiftKeyDown()){
	        list.add(EnumChatFormatting.RED + "A shiny, silverish, and flexible pipe of aluminum." + EnumChatFormatting.RESET);
