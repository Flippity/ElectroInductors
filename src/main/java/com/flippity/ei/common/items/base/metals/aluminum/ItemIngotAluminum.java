...
public class ItemIngotAluminum extends Item{
	...
	public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean par3) {
	    ...
	    if(GuiScreen.isShiftKeyDown()){
	        list.add(EnumChatFormatting.RED + "A shiny, silverish, and flexible bar of aluminum." + EnumChatFormatting.RESET);
	        ...
	        if(GuiScreen.isCtrlKeyDown()) {
	            ...
	            list.add(EnumChatFormatting.LIGHT_PURPLE + "1" + EnumChatFormatting.RESET + "x" + EnumChatFormatting.YELLOW + "Aluminum Dust");
	            list.add(EnumChatFormatting.RED + "OR");
	            list.add(EnumChatFormatting.LIGHT_PURPLE + "1" + EnumChatFormatting.RESET + "x" + EnumChatFormatting.YELLOW + "Aluminum Ore");
	        }
	    }
	}
    ...
    {
    	return MetalConstants.aluminum;
    }
}
