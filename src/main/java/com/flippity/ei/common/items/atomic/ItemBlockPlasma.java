...
public class ItemBlockPlasma extends ItemBlock{

	public ItemBlockPlasma(Block block) {
		super(block);
	}
	...
	public void addInformation(ItemStack itemStack, EntityPlayer player, List list, boolean par3) {
	    ...
	    if(GuiScreen.isShiftKeyDown()){
	        list.add(EnumChatFormatting.RED + "Extremely hot, can be used in fusion" + EnumChatFormatting.RESET);
