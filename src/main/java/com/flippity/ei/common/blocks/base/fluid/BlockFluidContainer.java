 ...
 *
 */
public abstract class BlockFluidContainer extends BlockContainer implements IFluidBlock
{
    ...
    public BlockFluidContainer(Fluid fluid, Material material)
    {
        super(material);
    ...
    public BlockFluidContainer setQuantaPerBlock(int quantaPerBlock)
    {
    ...
    public BlockFluidContainer setDensity(int density)
    {
    ...
    public BlockFluidContainer setTemperature(int temperature)
    {
        this.temperature = temperature;
        return this;
    }

    public BlockFluidContainer setTickRate(int tickRate)
    {
    ...
    public BlockFluidContainer setRenderPass(int renderPass)
    {
        this.renderPass = renderPass;
        return this;
    }

    public BlockFluidContainer setMaxScaledLight(int maxScaledLight)
    {
    ...
    {
        Block block = world.getBlock(x, y, z);
        if (!(block instanceof BlockFluidContainer))
        {
            return Integer.MAX_VALUE;
        }
        return ((BlockFluidContainer)block).density;
    }
    ...
    public static final int getTemperature(IBlockAccess world, int x, int y, int z)
    {
        ...
        return ((BlockFluidContainer)block).temperature;
    }
    ...
    public static double getFlowDirection(IBlockAccess world, int x, int y, int z)
    {
        ...
        Vec3 vec = ((BlockFluidContainer) block).getFlowVector(world, x, y, z);
